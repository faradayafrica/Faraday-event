                ...
                <div key={i} className="animate-pulse odd:bg-[#F1F2F6] py-8">
                  <div className="container md:flex gap-12">
                    ...
                    <div className="animate-pulse space-y-3 my-3 w-full">
                      <div class="w-[60%] h-[10px] bg-[#0000003d] rounded"></div>
                      <div class="w-[70%] h-[10px] bg-[#0000003d] rounded mt-3"></div>
                      <div class="w-full h-[10px] bg-[#0000003d] rounded"></div>
                      <div class="w-full h-[10px] bg-[#0000005d] rounded"></div>
                      <div class="w-full h-[10px] bg-[#0000005d] rounded"></div>
                      <div class="w-full h-[10px] bg-[#0000005d] rounded"></div>
                      <div class="w-full h-[10px] bg-[#0000005d] rounded"></div>
                      <div class="w-[50%] h-[10px] bg-[#0000005d] rounded"></div>
                    </div>
                  </div>
                </div>
              ))
